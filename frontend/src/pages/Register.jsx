...
import { UserPlus, Mail, Lock, User, Briefcase, Award, X, Plus, ChevronDown, Eye, EyeOff, Search, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function Register() {
  const [formData, setFormData] = useState({
    ...
    phone: '', dialCode: '+1', businessName: '', hourlyRate: 55, zipCode: '10001', skills: []
  });
